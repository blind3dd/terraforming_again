# Sandbox Environment Terraform Variables
# This file contains the actual values for the sandbox environment
...
# Security Groups
ssh_cidr_blocks = ["10.2.0.0/16"]  # Only allow SSH from VPC
http_cidr_blocks = ["10.2.0.0/16"]  # Only allow HTTP from VPC
https_cidr_blocks = ["10.2.0.0/16"]  # Only allow HTTPS from VPC
...
rds_database_name = "database_ci_sandbox"
rds_master_username = "admin"
rds_master_password = "SandboxPassword123!"
rds_master_password_param = "/rds/sandbox/master-password"
...
route53_records = {
  "sandbox-api" = {
    ...
    type = "A"
    ttl = 300
    records = ["10.2.10.10"]  # Will be updated with actual EC2 private IP
    zone_type = "private"
  }
  "sandbox-web" = {
    name = "sandbox-web"
    type = "A"
    ttl = 300
    records = ["10.2.10.11"]  # Will be updated with actual EC2 private IP
    zone_type = "private"
  }
  "sandbox-rds" = {
    name = "sandbox-rds"
    type = "CNAME"
    ttl = 300
    records = ["database-ci-sandbox-rds.internal.coderedalarmtech.com"]
    zone_type = "private"
  }
}
create_certificate = false
certificate_domain_name = "*.sandbox.example.com"
